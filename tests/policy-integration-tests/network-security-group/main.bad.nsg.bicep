...
metadata summary = 'Deploys test network security group resource that should violate some policy assignments.'
    ...
    securityRules: [
      {
        ...
        properties: {
          ...
          sourceAddressPrefix: 'AzureCloud' //should violate policy NSG-003
      ...
      }
      {
        ...
        properties: {
          ...
          destinationPortRange: '443'
          sourceAddressPrefix: '*'
          destinationAddressPrefix: 'Storage.WestUS' //should violate policy NSG-004
          priority: 200
          direction: 'Outbound'
        }
      }
