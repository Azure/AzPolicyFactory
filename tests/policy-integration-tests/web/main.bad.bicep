...
module webApp 'br/public:avm/res/web/site:0.22.0' = {
  ...
  params: {
    ...
    kind: 'app,linux'
    outboundVnetRouting: {
      applicationTraffic: false //This should violate policy WEB-005: App Service apps should enable outbound non-RFC 1918 traffic to Azure Virtual Network
    }
...
resource webAppConfig 'Microsoft.Web/sites/config@2025-03-01' = {
  ...
  properties: {
    identityProviders: {
      ...
      } //This should violate policy WEB-003: Function apps should only use approved identity providers for authentication
    }
  }
}
module functionApp 'br/public:avm/res/web/site:0.22.0' = {
  ...
  params: {
    ...
    httpsOnly: false //This should violate policy WEB-002: App Service and Function apps should only be accessible over HTTPS
    outboundVnetRouting: {
      contentShareTraffic: false //This should violate policy WEB-006: App Service and Function apps should route configuration traffic over the virtual network
    }
    configs: [
      {
        name: 'appsettings'
...
resource functionAppSlot 'Microsoft.Web/sites/slots@2025-03-01' = {
  ...
  properties: {
    ...
    outboundVnetRouting: {
      contentShareTraffic: false //This should violate policy WEB-008: Function app slots should route configuration traffic over the virtual network
      applicationTraffic: false //This should violate policy WEB-007: Function apps should route configuration traffic over the virtual network
    }
  }
}
